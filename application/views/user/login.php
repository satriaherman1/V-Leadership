...
<div class="container ">
    <form class="justify-content-center" method="post" action="<?= base_url(); ?>user/login" >
        ...
        <div class="input-group mb-3">
            ...
            <input type="text"  placeholder="token" name="token" id="token" aria-label="Username" aria-describedby="basic-addon1" onfocus="input()">
        </div>



    <button class="btn mx-auto" style="color:#fff;" name="submit" id="submit" type="submit">Login</button>
